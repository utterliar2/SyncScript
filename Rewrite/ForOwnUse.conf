...
# ✅ ❎ 🔴 ❌
# ©️公众号墨鱼手记
# 以下APP解锁，适用最新版，墨鱼都已测试其有效性
##################################################

hostname = api.revenuecat.com, notability.com, pan.baidu.com, spclient.wg.spotify.com, *account.wps*, commerce-i18n-api.faceu.mobi, commerce-api.faceu.mobi, pay.wecut.com, oauth.secure.pixiv.net, ticktick.com, dida365.com, ap*.intsig.net, ipadcms.caixin.com, server.yoyiapp.com, gw.aoscdn.com, *.xiuxiu.meitu.com, claritywallpaper.com, api.meiease.cn, restore-access.indream.app, appraven.net
